  ...
  <div class="container padding-medium">
    <div class="row">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            ...
            <a href="{{ route('single-article', ['id' => $article->id]) }}"><img src="{{ asset('images/articles/') . '/' . $article->image }}" class="img-fluid rounded-top-4 " alt="image"></a>
            <div class="card-body p-3">
                ...
                our greatest
                achievements, and the best hope for children sustainable future. <span><a href="{{ route('single-article', ['id' => $article->id]) }}"
                    class="text-decoration-underline">Read more</a></span> </p>
            </div>
            </div>
        </div>            
        @endforeach      
