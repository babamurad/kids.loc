        ...
        <div class="swiper slider ">
            <div class="swiper-wrapper">
                <div class="swiper-slide d-flex jarallax position-relative"
                     style="background-image: url({{ asset('images/slider-image.jpg') }}); background-size: cover; background-repeat: no-repeat; height: 80vh; background-position: center; height: 80vh;">
                    ...
                    <div class="banner-content text-center m-auto" data-aos="zoom-out">
                        <h2 class="banner-title display-1 text-white mb-4">Great platform for Little Explorers</h2>
                        <a href="about.html" class="btn btn-primary mt-3">about us</a>
                    </div>

                </div>
                <div class="swiper-slide d-flex jarallax position-relative"
                     style="background-image: url({{ asset('images/slider-image1.jpg') }}); background-size: cover; background-repeat: no-repeat; height: 80vh; background-position: center; height: 80vh;">
                    ...
                    <div class="banner-content text-center m-auto" data-aos="zoom-out">
                        <h2 class="banner-title display-1 text-white mb-0">Great platform for Little Explorers</h2>
                        <a href="about.html" class="btn btn-primary mt-3">about us</a>
                    </div>
                </div>
                <div class="swiper-slide d-flex jarallax position-relative"
                     style="background-image: url({{ asset('images/slider-image2.jpg') }}); background-size: cover; background-repeat: no-repeat; height: 80vh; background-position: center; height: 80vh;">
    ...
    <section id="activities" class="bg-gray">
        <div class="container padding-medium">
            ...
            <div class="text-center mb-5">
                ...
                <button class="filter-button py-2 px-4 me-4 mt-2 mt-md-0" data-filter=".sports">Sports</button>
            </div>
