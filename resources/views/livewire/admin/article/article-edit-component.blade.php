    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Makalany düzetmek</h4>
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Düzetmek</li>
                    </ol>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="form-group mt-1">
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="newImage">Surat saýla</label>
