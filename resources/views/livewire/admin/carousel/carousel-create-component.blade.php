    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Carousel Item Create</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active"><a href="{{ route('admin.teachers') }}">Carousel</a> </li>
        ...
        <div class="col-sm-9">
            <div class="card">
                ...
                <div class="card-footer">
                    <a wire:navigate href="{{ route('admin.carousel') }}" class="btn btn-secondary waves-effect waves-light">Close</a>
